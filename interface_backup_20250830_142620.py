...
class ApostasApp:
    ...
    def _criar_interface_completa(self):
        """Criar a interface completa após autenticação"""
        self.setup_window()
        self.create_widgets()
        
        # Aplicar tema e idioma salvos após criar widgets
        self._aplicar_configuracoes_iniciais()
        
        self.load_data()
        self.interface_criada = True
        print("✅ Interface principal criada com sucesso")
    ...
    def create_main_content(self):
        ...
        # Adicionar widget de gamificação se disponível
        if VERSAO_2_DISPONIVEL:
            # Widget de gamificação removido
            pass
